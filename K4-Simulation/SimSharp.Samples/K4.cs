...
namespace SimSharp.Samples
{
    public class K4
    {
        ...
        {
            public Patient(string _KID, DateTime _waitingTime, DateTime _TTL, DateTime _arrivalTime)//placeholder for patient class
            {
                KID = _KID;
        ...
        static IEnumerable<Event> Steuerprozess(Environment env, List<Patient> patients)//Simulator start, Timer starts!
        {
            ...
            foreach (Patient pat in patients)
            {
                ...
                eventLog.getLog().addLog(env.Now.ToLongTimeString(), pat.TTL.ToLongTimeString(), pat.KID, "---", "arrived");
        ...
        static IEnumerable<Event> Triage(Environment env, Patient pat)
        {
            ...
            eventLog.getLog().addLog(env.Now.ToLongTimeString(), pat.TTL.ToLongTimeString(), pat.KID, "---", "at triage");
            ...
            pat.TTL = pat.TTL - support;//subtract Timespan


            //Triage number part should be insertet here....................................

            //patient finaly printed to log with triage number
            eventLog.getLog().addLog(env.Now.ToLongTimeString(), pat.TTL.ToLongTimeString(), pat.KID, "generated number", "get number");
        ...
        public void RunSimulation()
        {
            ...
            env.Process(Steuerprozess(env, patients));
            env.RunD();
