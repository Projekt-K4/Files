...
namespace SimSharp.Samples
{
    class Parameter
    {
        ...
        public void initialize(int _OPWaiting, int _mortuary, int _ward, int _triageTime, int _arriveMin, int _arriveMax, int _OPWinTime, int _OPMin, int _OPMax, int _OPDyingRate)
        {
